...
public class CommonUtils 
{
	...
	public static String encriptString(Object object) {

		String returnString = null;
		try {
			MessageDigest md = MessageDigest.getInstance("MD5");
			md.update(((String) object).getBytes());
	...
	public static com.example.demo.response.Response getResponseObject(String message) {
